...
AZ_CM_MLCanConfig2015-2017.mat: configuration file to set up for Charleston Mesquite (CM) site before running Multi-layer canopy (MLCan) model. Configuration file includes soil & radiation parameters (% of sand, % of clay, reflection coefficient, etc), respiration & microenvironment parameters (Ro, Q10), leaf & canopy parameters (leaf width, canopy height, fluc tower height, etc), and photosynthesis parameters (Vcmac, Jmax, Rd25, etc). Use this configuration file to run MLCan to generate results published in Lee, Kumar, Knowles, et al, WRR 2020 (in review). 

AZ_CM_MLCanForcing2015-2017.mat: forcing file for Charleston Mesquite (CM) site to run Multi-layer canopy (MLCan) model. Forcing file includes leaf area indices of coexisting plants, leaf area density over the canopy, etc. Use this forcing file to run MLCan to generate results published in Lee, Kumar, Knowles, et al, WRR 2020 (in review). 
...
readme.txt: readme file for CMsoil20XX.mat provides depths of soil where soil moisture and temperature are measured. 
