...
function [remain] = Teffentropy (SSdirin, SSdifin, SSdirout, SSdifout, SSLWin,... 
SSecotot, LWout, LEnet, Hnet, Gnet, X, Tefe)
...
% Level
   ...
   %     remain = - SSecotot + SSdifin + SSdirin + SSLWin...
   %     - (SSdirout + SSdifout + (4/3)*X*LWout/Tefe + LEnet/Tefe + Hnet/Tefe + Gnet/Tefe);
