% Plot Diurnal Canopy Shortwave Radiation Absorption and Emittance
    ...
    % PAR
        subplot(4,2,1)
            pcolor(hr, zhc, PARabs_canopy_diurnal_prof)
            shading interp
            colorbar
            caxis([minPAR maxPAR])
        ...
        subplot(4,2,3)
            pcolor(hr, zhc, PARabs_sun_diurnal_prof)
            shading interp
            colorbar
            caxis([minPAR maxPAR])
            ...
            ylabel('\bf z / h', 'FontSize', 12)
        subplot(4,2,5)
            pcolor(hr, zhc, PARabs_shade_diurnal_prof)
            shading interp
            colorbar
            caxis([minPAR maxPAR])
    ...
    % NIR
        subplot(4,2,2)
            pcolor(hr, zhc, NIRabs_canopy_diurnal_prof)
            shading interp
            colorbar
            caxis([minNIR maxNIR])
            ...
            ylabel('\bf z / h', 'FontSize', 12)
        subplot(4,2,4)
            pcolor(hr, zhc, NIRabs_sun_diurnal_prof)
            shading interp
            colorbar
            caxis([minNIR maxNIR])
            ...
            ylabel('\bf z / h', 'FontSize', 12)
        subplot(4,2,6)
            pcolor(hr, zhc, NIRabs_shade_diurnal_prof)
            shading interp
            colorbar
            caxis([minNIR maxNIR])
     ...
     % LW
        subplot(4,2,7)
            pcolor(hr, zhc, LWabs_can_diurnal_prof)
            shading interp
            colorbar
            %caxis([minNIR maxNIR])
        ...
        subplot(4,2,8)
            pcolor(hr, zhc, LWemit_can_diurnal_prof)
            shading interp
            colorbar
            %caxis([minNIR maxNIR])
