...
% BINNED AVERAGES
    ...
    % BINNED OBSERVATIONS - DAY
        [Fc_in_Rgbins_avg, Fc_in_Rgbins_std, Rgbin_avg] = Bin_Average (Rg_in, Fc_in, Rg_bins);
        [Fc_in_Tabins_avg, Fc_in_Tabins_std, Tabin_avg] = Bin_Average (Ta_in, Fc_in, Ta_bins);
        [Fc_in_VPDbins_avg, Fc_in_VPDbins_std, VPDbin_avg] = Bin_Average (VPD_in, Fc_in, VPD_bins);
        [Fc_in_Ubins_avg, Fc_in_Ubins_std, Ubin_avg] = Bin_Average (U_in, Fc_in, U_bins);

        [LE_in_Rgbins_avg, LE_in_Rgbins_std, Rgbin_avg] = Bin_Average (Rg_in, LE_in, Rg_bins);
        [LE_in_Tabins_avg, LE_in_Tabins_std, Tabin_avg] = Bin_Average (Ta_in, LE_in, Ta_bins);
        [LE_in_VPDbins_avg, LE_in_VPDbins_std, VPDbin_avg] = Bin_Average (VPD_in, LE_in, VPD_bins);
        [LE_in_Ubins_avg, LE_in_Ubins_std, Ubin_avg] = Bin_Average (U_in, LE_in, U_bins);

        [H_in_Rgbins_avg, H_in_Rgbins_std, Rgbin_avg] = Bin_Average (Rg_in, H_in, Rg_bins);
        [H_in_Tabins_avg, H_in_Tabins_std, Tabin_avg] = Bin_Average (Ta_in, H_in, Ta_bins);
        [H_in_VPDbins_avg, H_in_VPDbins_std, VPDbin_avg] = Bin_Average (VPD_in, H_in, VPD_bins);
        [H_in_Ubins_avg, H_in_Ubins_std, Ubin_avg] = Bin_Average (U_in, H_in, U_bins);

    % BINNED MODELED FLUXES - DAY
        [Fc_mod_Rgbins_avg, Fc_mod_Rgbins_std] = Bin_Average (Rg_in, Fc_eco_store, Rg_bins);
        [Fc_mod_Tabins_avg, Fc_mod_Tabins_std] = Bin_Average (Ta_in, Fc_eco_store, Ta_bins);
        [Fc_mod_VPDbins_avg, Fc_mod_VPDbins_std] = Bin_Average (VPD_in, Fc_eco_store, VPD_bins);
        [Fc_mod_Ubins_avg, Fc_mod_Ubins_std] = Bin_Average (U_in, Fc_eco_store, U_bins);

        [LE_mod_Rgbins_avg, LE_mod_Rgbins_std] = Bin_Average (Rg_in, LE_eco_store, Rg_bins);
        [LE_mod_Tabins_avg, LE_mod_Tabins_std] = Bin_Average (Ta_in, LE_eco_store, Ta_bins);
        [LE_mod_VPDbins_avg, LE_mod_VPDbins_std] = Bin_Average (VPD_in, LE_eco_store, VPD_bins);
        [LE_mod_Ubins_avg, LE_mod_Ubins_std] = Bin_Average (U_in, LE_eco_store, U_bins);

        [H_mod_Rgbins_avg, H_mod_Rgbins_std] = Bin_Average (Rg_in, H_eco_store, Rg_bins);
        [H_mod_Tabins_avg, H_mod_Tabins_std] = Bin_Average (Ta_in, H_eco_store, Ta_bins);
        [H_mod_VPDbins_avg, H_mod_VPDbins_std] = Bin_Average (VPD_in, H_eco_store, VPD_bins);
        [H_mod_Ubins_avg, H_mod_Ubins_std] = Bin_Average (U_in, H_eco_store, U_bins);
